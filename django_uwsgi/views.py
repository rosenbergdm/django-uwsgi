    ...
    def get(self, request):
        ...
        if uwsgi is not None and uwsgi.masterpid() > 0:
            ...
            messages.add_message(
                request, messages.SUCCESS, _("uWSGI Cache cleared!"), fail_silently=True
            )
        else:
            messages.add_message(
                request,
    ...
    def post(self, request):
        ...
        if uwsgi is not None:
            ...
            messages.add_message(
                request,
                messages.SUCCESS,
                _("uWSGI Log message has been sent!"),
                fail_silently=True,
            )
        else:
            messages.add_message(
